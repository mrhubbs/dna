...
class tests(test_utils):
    ...
    def test_1_insert_before(self):
        self.crawler.insert_before(self.n2)
    ...
    def test_2_insert_after(self):
        self.crawler.insert_after(self.n2)
    ...
    def test_3_insert_child(self):
        self.crawler.insert_child(self.n3)
    ...
    def test_4_remove_head(self):
        c = self.crawler
        c.insert_after(self.n2, self.n1)
        c.insert_after(self.n3, self.n2)
        c.remove(self.n1)
    ...
    def test_8_traverse_sibs(self):
        c = self.crawler
        c.insert_child(self.n2, self.n1)
        c.insert_after(self.n3, self.n1)
